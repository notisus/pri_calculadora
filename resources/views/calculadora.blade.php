    ...
    <div class="panel panel-primary" style="color:black!important">
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-2 text-right d-none d-md-block"><img src="{{ asset('images/pri2023b.png') }}"/>&nbsp;</div>
            </div>
        </div>
    </div>
</div>
...
<div class="container">
    ...
    <div class="py-3 text-center">
        <img class="d-block mx-auto mb-4" src="{{ asset('images/pri.png') }}" alt="" width="90" height="50" style="display:none!important"/>
    ...
    <div class="row">
        <div class="col-md-6 order-2 mb-0" id="custoPreenchimento" style="display:none;">
                ...
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        ...
                        <small class="text-muted" style="font-size: 15px;"> Este é o <span
                                ...
                                Zerar <img style="margin-top:-18px;" src="{{ asset('images/Check_PRI.png') }}"/></strong></small>
                    </div>
                </li>
            </ul>
            ...
            <p class="bg-light  text-center">
                <span style="text-align:center!important"><a
                        href="https://web.whatsapp.com/send?phone=+5511995851973"><img src="{{ asset('images/qrCode2.png') }}"/></a></span>
                <br/>
        ...
        <div class="col-md-6 order-1">
            ...
            <div class="needs-validation" novalidate>
                <div class="mb-3">
                    <img src="{{ asset('images/Seta.png') }}"/>&nbsp; <label for="email"> Informe a quantidade de LOJAS da sua REDE</label>
                ...
                <div class="mb-3">
                    <img src="{{ asset('images/Seta.png') }}"/>&nbsp; <label for="email">Informe a quantidade média de repositores por
                        LOJA</label>
                ...
                <div class="mb-3">
                    <label for="custoEquipeRede99" id="custoEquipeRede1" style="display:none"><img src="{{ asset('images/Seta.png') }}"/>
